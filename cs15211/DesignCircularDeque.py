...
# key is to maintain pointer at first/last index
 ...
 */
 ...
 class MyCircularDeque {
    ...
    public boolean insertFront(int value) {
        ...
        size++;
        arr[first] = value;
        //System.out.println("add front #"+first+" "+arr[first]);
        first = (first-1+capacity) % capacity;
    ...
    public boolean insertLast(int value) {
        ...
        size++;
        arr[last] = value;
        //System.out.println("add rear #"+last+" "+arr[last]);
    ...
    /** Get the last item from the deque. */
    public int getRear() {
        return isEmpty() ? -1 : arr[(last-1+capacity) % capacity];
    }
