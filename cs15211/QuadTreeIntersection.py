__source__ = 'https://leetcode.com/problems/quad-tree-intersection/'
# Time:  O()
# Space: O()
#
# Description: Leetcode # 558. Quad Tree Intersection
#
...
# For each node, it will be subdivided into four children nodes until the values in the region
# it represents are all the same. Each node has another two boolean attributes : isLeaf and val.
