__source__ = 'https://leetcode.com/problems/contiguous-array/'
# Time:  O(n)
# Space: O(n)
#
# Description: Leetcode # 525. Contiguous Array
#
...
Java = '''
# Thought: https://leetcode.com/problems/contiguous-array/solution/
