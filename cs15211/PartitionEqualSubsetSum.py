__source__ = 'https://github.com/kamyu104/LeetCode/blob/master/Python/partition-equal-subset-sum.py'
...
Java = '''
#Thought: http://love-oriented.com/pack/P01.html backpack problem
