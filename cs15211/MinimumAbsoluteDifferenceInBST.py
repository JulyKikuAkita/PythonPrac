__source__ = 'https://leetcode.com/problems/minimum-absolute-difference-in-bst/#/description'
# Time:  O()
# Space: O()
#
# Description:
...
Java = '''
#Thought: https://discuss.leetcode.com/topic/80823/two-solutions-in-order-traversal-and-a-more-general-way-using-treeset
