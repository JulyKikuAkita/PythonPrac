__source__ = 'https://leetcode.com/problems/ipo/#/description'
# Time:  O(nlogn)
# Space: O(nlogn)
#
...
#
# You are given several projects. For each project i, it has a pure profit Pi and a minimum capital of Ci
