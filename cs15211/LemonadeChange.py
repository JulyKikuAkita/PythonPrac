__source__ = 'https://leetcode.com/problems/lemonade-change/'
# Time:  O(N)
# Space: O(1)
#
# Description: Leetcode # 860. Lemonade Change
#
...
Java = '''
# Thought: https://leetcode.com/problems/lemonade-change/solution/
#
# 4ms 93.78%
class Solution {
