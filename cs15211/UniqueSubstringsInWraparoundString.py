__source__ = 'https://github.com/kamyu104/LeetCode/blob/master/Python/unique-substrings-in-wraparound-string.py'
# Time:  O(n)
# Space: O(1)
#
# Description:
...
If there are overlapping, we only need to consider the longest one because it covers
all the possible substrings. Example: "abcdbcd", the max number of unique substring ends with 'd' is 4
